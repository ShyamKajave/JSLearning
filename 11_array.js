...
// console.log(array);
// console.log(`The given array type is: ${typeof array}`);
// console.log(`Total number of element in array is: ${array.length}`);
// let element = array[array.length-3];
// console.log(`Index at 2 in array is: ${element}`);
// let last = array.length;
// let laste= array[last-1];
// console.log(`${laste}`);
// console.log(`-------------------------------`);
// array[1]=100;
// console.log(array);
